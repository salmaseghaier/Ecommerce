...
<p>Lorem ipsum dolor sit amet,sonsectetur </p>
...
<section id="about-head" class="section-p1">
    ...
    <div>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit , sed do eiusmod tempor incididunt ut labore
             et dolore magna aliqua .Ut enin ad mini veniam, quis nostrud exercitation ullamco 
            laboris nisi ut aliquip ex ea commodo consequat. Duis auteirure dolor in reprehendreit in vuluptate 
            velit esse cillum dolore eu fugiat nulla pariateur.Excepteur sint occaesact cupidatat non proident,sunt in culpa qui officia 
            desernut mollit anim id est laborum.</p>
        <abbr title="">Create stunnig images with as much or as little control as  you like
             thanks to a choice of Basic and Creative modes.
        </abbr> 
        <br><br>
        <marquee bgcolor="#ccc" loop="-1" scrollamount="S" width="100%" >Create stunnig images with as much or as little control as  you like
